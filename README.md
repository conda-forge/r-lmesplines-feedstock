...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-lmesplines-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9719&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-lmesplines-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-lmesplines` can be installed with:

```
conda install r-lmesplines
```

It is possible to list all of the versions of `r-lmesplines` available on your platform with:
